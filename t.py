  ...
  with tab2:
   ...
   if Type == 'แท่ง':
    ...
    for topic_bar in list_bar_chart:
     ...
     # ตรวจสอบว่าผู้ใช้เลือกหัวข้อไหนใน sidebar
     if st.sidebar.text('หัวข้อใดที่ประสงค์เพิ่มข้อมูลของผู้ไม่ตอบแบบสอบถามในกราฟ') == topic_bar:
     ...
     if st.sidebar.text('หัวข้อใดที่ประสงค์เพิ่มคำอธิบาย') == topic_bar:
     ...
     if st.sidebar.text('จำนวนความถี่ขั้นต่ำของแต่ละกราฟที่ประสงค์ให้ปรากฎแท่งในกราฟแต่ละหัวข้อ') == topic_bar:
      c = Count(upload_df[topic_bar].values.tolist())
