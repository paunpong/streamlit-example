...
def create_word_doc(Pie_chart,com_bar,Bar_chart,Box_chart,St_str,St_num,Num_st,Str_st,
 ...
 for pie in Pie_chart:
  doc.add_picture(pie, width=Cm(10.16), height=Cm(15.24))
 ...
 for box in Box_chart:
  doc.add_picture(box, width=Cm(10.16), height=Cm(15.24))
 ...
 for com in Com_bar:
  doc.add_picture(com, width=Cm(10.16), height=Cm(15.24))
 ...
 for bar in Bar_chart:
  doc.add_picture(bar, width=Cm(10.16), height=Cm(15.24))
 ...
 for str in St_str:
  doc.add_picture(str, width=Cm(10.16), height=Cm(15.24))
 ...
 for num in St_num:
  doc.add_picture(num, width=Cm(10.16), height=Cm(15.24))
