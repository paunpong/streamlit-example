...
def create_word_doc(Pie_chart,com_bar,Bar_chart,Box_chart,St_str,St_num,Num_st,Str_st,
 ...
 for box in Box_chart:
  doc.add_picture(box, width=Cm(15), height=Cm(10))
 ...
 for com in Com_bar:
  doc.add_picture(com, width=Cm(15), height=Cm(10))
 ...
 for bar in Bar_chart:
  doc.add_picture(bar, width=Cm(15), height=Cm(10))
 ...
 for str in St_str:
  doc.add_picture(str, width=Cm(15), height=Cm(10))
 ...
 for num in St_num:
  doc.add_picture(num, width=Cm(15), height=Cm(10))
