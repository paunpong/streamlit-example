...
if menu == 'เริ่มต้นโปรแกรม':
 ...
 with st.expander('### :red[คำแนะนำ]',expanded=True):
  ...
  st.image("browse.png")
  st.text('3. เลือกประเภทของกราฟที่ต้องการของแต่ละหัวข้อ')
  st.text('4. ปรับแต่งรายละเอียดของกราฟประเภทต่าง ๆ ')
  st.text('5. เมื่อได้รูปแบบที่ต้องการแล้วกดดาวน์โหลดเพื่อโหลดไฟล์ docs')
