...
if menu == 'เริ่มต้นโปรแกรม':
 ...
 with st.expander('### :red[คำแนะนำ]',expanded=True):
  st.markdown('**1. โหลดไฟล์ออกจากแบบฟอร์มที่ได้ทำการสร้างแบบสอบถาม**')
  st.image("download.png")
  st.markdown("""---""")
  st.markdown('**2. กด Browse files จากนั้นเลือกไฟล์แบบสอบถามที่ต้องการ**')
  st.image("browse.png")
  st.markdown("""---""")
  st.markdown('**3. เลือกประเภทของกราฟที่ต้องการของแต่ละหัวข้อ**')
  st.image("type.png")
  st.markdown("""---""")
  st.markdown('**4. ปรับแต่งรายละเอียดของกราฟประเภทต่าง ๆ**')
  st.image("customize.png")
  st.markdown("""---""")
  st.markdown('**5. เมื่อได้รูปแบบที่ต้องการแล้วกดปุ่มดาวน์โหลดเพื่อโหลดไฟล์ docs**')
