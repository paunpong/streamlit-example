...
def stacked_bar(data,key):
 ...
 ax.set_yticklabels(name, fontproperties=thai_font_prop, fontsize=14)
 d_f = pd.DataFrame(data1,index=name)
 
 d_f.plot.barh(stacked=True, figsize=(8,3), ax=ax).legend(bbox_to_anchor=(1, 0, 0.19, 1), prop=thai_font_prop, fontsize=14)
 plt.title(key,fontproperties=thai_font_prop, fontsize=16)
